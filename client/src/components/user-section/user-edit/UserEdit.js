          ...
          <form>
            ...
            <div className="htmlForm-row">
              <div className="htmlForm-group">
                ...
                <p className="htmlForm-error">Email is not valid!</p>
              </div>
              <div className="htmlForm-group">
                ...
                <p className="htmlForm-error">Phone number is not valid!</p>
              </div>
            </div>
            ...
            <div className="htmlForm-group long-line">
              ...
              <p className="htmlForm-error">ImageUrl is not valid!</p>
            </div>
